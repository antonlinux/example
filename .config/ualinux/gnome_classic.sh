...
, 'CoverflowAltTab@palatis.blogspot.com', 'desktop-icons@csoriano', 'system-monitor@paradoxxx.zero.gmail.com']"

gsettings set org.gnome.shell disable-user-extensions false

# final

 mv ~/.config/autostart/ualinux_gnome_classic.desktop ~/.config/autostart/.ualinux_gnome_classic.desktop
