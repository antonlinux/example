...
, 'CoverflowAltTab@palatis.blogspot.com', 'desktop-icons@csoriano', 'dash-to-panel@jderose9.github.com', 'system-monitor@paradoxxx.zero.gmail.com']"

gsettings set org.gnome.shell disable-user-extensions false

# final

mv ~/.config/autostart/ualinux_gnome_win.desktop ~/.config/autostart/.ualinux_gnome_win.desktop
